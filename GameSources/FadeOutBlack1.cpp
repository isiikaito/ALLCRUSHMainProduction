...
namespace basecross {
	...
	FadeOutBlack1::FadeOutBlack1(const shared_ptr<Stage>& StagePtr, bool Trace,
	...
	FadeOutBlack1::~FadeOutBlack1() {}
	void FadeOutBlack1::OnCreate() {
